 ...
 * For example, command-line only emulators.
...
#ifndef EXECUTE_APP
	#define TITLE_WINDOW "Simple File browser"
	#define FORMAT_FILE ".tns"
	#define EXECUTABLE_NAME "browser.tns"
	#define DEFAULT_TEXT "Simple File browser"
#else
	#define TITLE_WINDOW "Hugo"
	#define FORMAT_FILE ".pce"
	#define EXECUTABLE_NAME "hugo.tns"
	#define DEFAULT_TEXT "Select a PC-ENGINE Hucard Rom"
#endif
